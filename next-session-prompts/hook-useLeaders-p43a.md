...
`ti4-companion-web/docs/superpowers/plans/main_plan/hook-useLeaders-p43a.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `hook-useLeaders-p43a` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/hook-useLeaders-p43a.md`
