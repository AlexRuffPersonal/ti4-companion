# Task: fn-game-fire-bombardment-p43c
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-fire-bombardment-p43c.md`
...
`supabase/functions/game-fire-bombardment/index.ts`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-fire-bombardment-p43c` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-fire-bombardment-p43c.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy game-fire-bombardment --no-verify-jwt`
