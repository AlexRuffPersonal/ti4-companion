...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-draft-place-tile.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-draft-place-tile` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-draft-place-tile.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy game-draft-place-tile --no-verify-jwt`
