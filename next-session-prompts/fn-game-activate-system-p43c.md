# Task: fn-game-activate-system-p43c
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-activate-system-p43c.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-activate-system-p43c` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-activate-system-p43c.md`
