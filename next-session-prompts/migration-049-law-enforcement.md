# Task: migration-049-law-enforcement
...
`ti4-companion-web/docs/superpowers/plans/main_plan/migration-049-law-enforcement.md`
...
`supabase/migrations/049_law_enforcement.sql`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `migration-049-law-enforcement` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/migration-049-law-enforcement.md`
