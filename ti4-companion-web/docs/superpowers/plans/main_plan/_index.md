...
| [fn-game-confirm-transaction-p39b](fn-game-confirm-transaction-p39b.md) | `supabase/functions/game-confirm-transaction/index.ts` | 39b | Promissory Note DSL Effects | in-progress | fn-game-play-promissory-note-p39a, shared-promissoryEnforcement-p39a |
...
| [fn-game-commit-ground-forces-p39b](fn-game-commit-ground-forces-p39b.md) | `supabase/functions/game-commit-ground-forces/index.ts` | 39b | Promissory Note DSL Effects | in-progress | fn-game-play-promissory-note-p39a, shared-promissoryEnforcement-p39a |
...
| [fn-game-explore-planet-p39](fn-game-explore-planet-p39.md) | `supabase/functions/game-explore-planet/index.ts` | 41 | Exploration Full Validation | in-progress | fn-game-explore-planet, migration-051-exploration-fixes |
