# Task: fn-game-resolve-ability-mech
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-resolve-ability-mech.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-resolve-ability-mech` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-resolve-ability-mech.md`
