# Task: fn-game-resolve-commander-reroll
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-resolve-commander-reroll.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-resolve-commander-reroll` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-resolve-commander-reroll.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy game-resolve-commander-reroll --no-verify-jwt`
