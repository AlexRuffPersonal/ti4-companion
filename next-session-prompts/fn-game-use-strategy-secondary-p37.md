# Task: fn-game-use-strategy-secondary-p37
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-use-strategy-secondary-p37.md`
...
`supabase/functions/game-use-strategy-secondary/index.ts`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-use-strategy-secondary-p37` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-use-strategy-secondary-p37.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy game-use-strategy-secondary --no-verify-jwt`
