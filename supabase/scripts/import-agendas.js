// Run from the project root: node supabase/scripts/import-agendas.js
//
...
const JSON_FILE = path.resolve(__dirname, '../jsons/agendas.json')
const FUNCTION_URL = 'https://mgbagajfrfielqrjpuvi.supabase.co/functions/v1/admin-import-agendas'
...
async function main() {
  ...
  console.log(`Importing ${records.length} agendas...`)
