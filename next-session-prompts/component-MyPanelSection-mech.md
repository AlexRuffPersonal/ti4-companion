# Task: component-MyPanelSection-mech
...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-MyPanelSection-mech.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-MyPanelSection-mech` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-MyPanelSection-mech.md`
