...
| [fn-game-activate-system-p39b](fn-game-activate-system-p39b.md) | `supabase/functions/game-activate-system/index.ts` | 39b | Promissory Note DSL Effects | in-progress | fn-game-play-promissory-note-p39a, shared-promissoryEnforcement-p39a |
