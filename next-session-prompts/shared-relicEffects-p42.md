...
`ti4-companion-web/docs/superpowers/plans/main_plan/shared-relicEffects-p42.md`
...
`supabase/functions/_shared/relicEffects.ts`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `shared-relicEffects-p42` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/shared-relicEffects-p42.md`
