...
`ti4-companion-web/docs/superpowers/plans/main_plan/lib-importSchemas-mech.md`
...
`ti4-companion-web/src/lib/importSchemas.js`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `lib-importSchemas-mech` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/lib-importSchemas-mech.md`
