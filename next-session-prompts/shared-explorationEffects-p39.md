# Task: shared-explorationEffects-p39
...
`ti4-companion-web/docs/superpowers/plans/main_plan/shared-explorationEffects-p39.md`
...
`supabase/functions/_shared/explorationEffects.ts`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `shared-explorationEffects-p39` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/shared-explorationEffects-p39.md`
