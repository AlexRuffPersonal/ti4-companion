# Task: fn-game-create-transaction-p39b
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-create-transaction-p39b.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-create-transaction-p39b` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-create-transaction-p39b.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy game-create-transaction --no-verify-jwt`
