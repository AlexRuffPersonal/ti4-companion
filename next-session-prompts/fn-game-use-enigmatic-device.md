# Task: fn-game-use-enigmatic-device
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-use-enigmatic-device.md`
...
`supabase/functions/game-use-enigmatic-device/index.ts`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-use-enigmatic-device` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-use-enigmatic-device.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy game-use-enigmatic-device --no-verify-jwt`
