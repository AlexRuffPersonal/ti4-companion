# Task: component-MyPanelSection-icon-integration
...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-MyPanelSection-icon-integration.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-MyPanelSection-icon-integration` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-MyPanelSection-icon-integration.md`
