...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-GalaxyTab-p38.md`
...
`ti4-companion-web/src/components/game/GalaxyTab.jsx`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-GalaxyTab-p38` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-GalaxyTab-p38.md`
