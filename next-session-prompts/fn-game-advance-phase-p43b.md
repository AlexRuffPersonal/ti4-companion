# Task: fn-game-advance-phase-p43b
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-advance-phase-p43b.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-advance-phase-p43b` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-advance-phase-p43b.md`
