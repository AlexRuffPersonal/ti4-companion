// Run from the project root: node supabase/scripts/import-relics.js
//
...
const JSON_FILE = path.resolve(__dirname, '../jsons/relics.json')
const FUNCTION_URL = 'https://mgbagajfrfielqrjpuvi.supabase.co/functions/v1/admin-import-relics'
...
async function main() {
  ...
  console.log(`Importing ${records.length} relics...`)
