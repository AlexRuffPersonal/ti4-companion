# Task: fn-game-resolve-ability-p43b
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-resolve-ability-p43b.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-resolve-ability-p43b` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-resolve-ability-p43b.md`
