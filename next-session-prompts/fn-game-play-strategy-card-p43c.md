# Task: fn-game-play-strategy-card-p43c
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-play-strategy-card-p43c.md`
...
`supabase/functions/game-play-strategy-card/index.ts`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-play-strategy-card-p43c` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-play-strategy-card-p43c.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy game-play-strategy-card --no-verify-jwt`
