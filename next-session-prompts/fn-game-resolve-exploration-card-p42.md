# Task: fn-game-resolve-exploration-card-p42
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-resolve-exploration-card-p42.md`
...
`supabase/functions/game-resolve-exploration-card/index.ts`

## Phase / Feature Area
Phase 42 — Relic Card Effects A
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-resolve-exploration-card-p42` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-resolve-exploration-card-p42.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy game-resolve-exploration-card --no-verify-jwt`
