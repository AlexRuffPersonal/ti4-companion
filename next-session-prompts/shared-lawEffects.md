...
`ti4-companion-web/docs/superpowers/plans/main_plan/shared-lawEffects.md`
...
`supabase/functions/_shared/lawEffects.ts`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `shared-lawEffects` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/shared-lawEffects.md`
