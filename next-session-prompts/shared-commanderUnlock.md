...
`ti4-companion-web/docs/superpowers/plans/main_plan/shared-commanderUnlock.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `shared-commanderUnlock` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/shared-commanderUnlock.md`
