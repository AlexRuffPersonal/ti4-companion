# Task: component-LeaderPanel-mech
...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-LeaderPanel-mech.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-LeaderPanel-mech` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-LeaderPanel-mech.md`
