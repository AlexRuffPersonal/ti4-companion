# Task: migration-048-draft-state
...
`ti4-companion-web/docs/superpowers/plans/main_plan/migration-048-draft-state.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `migration-048-draft-state` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/migration-048-draft-state.md`
