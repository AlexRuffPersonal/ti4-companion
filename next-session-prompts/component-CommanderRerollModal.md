# Task: component-CommanderRerollModal
...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-CommanderRerollModal.md`
...
`ti4-companion-web/src/components/game/CommanderRerollModal.jsx`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-CommanderRerollModal` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-CommanderRerollModal.md`
