# Task: fn-game-resolve-agenda-p40
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-resolve-agenda-p40.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-resolve-agenda-p40` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-resolve-agenda-p40.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy game-resolve-agenda --no-verify-jwt`
