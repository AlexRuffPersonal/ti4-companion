# Task: component-HexTile-icon-integration
...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-HexTile-icon-integration.md`
...
`ti4-companion-web/src/components/game/HexTile.jsx`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-HexTile-icon-integration` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-HexTile-icon-integration.md`
