...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-draft-pick-slice.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-draft-pick-slice` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-draft-pick-slice.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy game-draft-pick-slice --no-verify-jwt`
