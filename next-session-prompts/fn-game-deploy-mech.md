...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-deploy-mech.md`
...
`supabase/functions/game-deploy-mech/index.ts`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-deploy-mech` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-deploy-mech.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy game-deploy-mech --no-verify-jwt`
