# Task: fn-game-resolve-exploration-card-p39
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-resolve-exploration-card-p39.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-resolve-exploration-card-p39` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-resolve-exploration-card-p39.md`
