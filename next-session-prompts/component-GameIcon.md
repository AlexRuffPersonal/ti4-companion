...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-GameIcon.md`
...
`ti4-companion-web/src/components/shared/GameIcon.jsx`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-GameIcon` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-GameIcon.md`
