...
`ti4-companion-web/docs/superpowers/plans/main_plan/shared-leaderEffects.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `shared-leaderEffects` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/shared-leaderEffects.md`
