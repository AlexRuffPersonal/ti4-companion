# Task: fn-game-explore-planet-p39
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-explore-planet-p39.md`
...
`supabase/functions/game-explore-planet/index.ts`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-explore-planet-p39` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-explore-planet-p39.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy game-explore-planet --no-verify-jwt`
