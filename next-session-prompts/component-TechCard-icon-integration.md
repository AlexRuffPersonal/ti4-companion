# Task: component-TechCard-icon-integration
...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-TechCard-icon-integration.md`
...
`ti4-companion-web/src/components/game/TechCard.jsx`

## Phase / Feature Area
Phase UI — SVG Icon Integration
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-TechCard-icon-integration` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-TechCard-icon-integration.md`
