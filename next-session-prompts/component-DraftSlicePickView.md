# Task: component-DraftSlicePickView
...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-DraftSlicePickView.md`
...
`ti4-companion-web/src/components/game/DraftSlicePickView.jsx`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-DraftSlicePickView` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-DraftSlicePickView.md`
