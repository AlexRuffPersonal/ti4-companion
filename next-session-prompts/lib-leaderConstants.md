...
`ti4-companion-web/docs/superpowers/plans/main_plan/lib-leaderConstants.md`
...
`ti4-companion-web/src/lib/leaderConstants.js`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `lib-leaderConstants` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/lib-leaderConstants.md`
