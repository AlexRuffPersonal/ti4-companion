# Task: migration-052-leader-abilities
...
`ti4-companion-web/docs/superpowers/plans/main_plan/migration-052-leader-abilities.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `migration-052-leader-abilities` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/migration-052-leader-abilities.md`
