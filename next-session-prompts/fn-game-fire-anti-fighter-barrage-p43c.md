# Task: fn-game-fire-anti-fighter-barrage-p43c
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-fire-anti-fighter-barrage-p43c.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-fire-anti-fighter-barrage-p43c` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-fire-anti-fighter-barrage-p43c.md`
