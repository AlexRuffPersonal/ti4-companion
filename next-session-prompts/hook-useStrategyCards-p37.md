# Task: hook-useStrategyCards-p37
...
`ti4-companion-web/docs/superpowers/plans/main_plan/hook-useStrategyCards-p37.md`
...
`ti4-companion-web/src/hooks/useStrategyCards.js`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `hook-useStrategyCards-p37` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/hook-useStrategyCards-p37.md`
