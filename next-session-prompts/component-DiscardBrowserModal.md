# Task: component-DiscardBrowserModal
...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-DiscardBrowserModal.md`
...
`ti4-companion-web/src/components/game/DiscardBrowserModal.jsx`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-DiscardBrowserModal` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-DiscardBrowserModal.md`
