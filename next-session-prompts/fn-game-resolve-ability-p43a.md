# Task: fn-game-resolve-ability-p43a
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-resolve-ability-p43a.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-resolve-ability-p43a` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-resolve-ability-p43a.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy game-resolve-ability --no-verify-jwt`
