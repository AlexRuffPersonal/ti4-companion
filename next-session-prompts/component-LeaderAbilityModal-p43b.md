# Task: component-LeaderAbilityModal-p43b
...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-LeaderAbilityModal-p43b.md`
...
`ti4-companion-web/src/components/game/LeaderAbilityModal.jsx`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-LeaderAbilityModal-p43b` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-LeaderAbilityModal-p43b.md`
