# Task: fn-admin-import-units-mech
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-admin-import-units-mech.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-admin-import-units-mech` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-admin-import-units-mech.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy admin-import-units --no-verify-jwt`
