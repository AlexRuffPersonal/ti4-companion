# Task: component-LeaderPanel-p43a
...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-LeaderPanel-p43a.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-LeaderPanel-p43a` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-LeaderPanel-p43a.md`
