...
`ti4-companion-web/docs/superpowers/plans/main_plan/client-edgeFunctions-p39.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `client-edgeFunctions-p39` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/client-edgeFunctions-p39.md`
