...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-unlock-commander.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-unlock-commander` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-unlock-commander.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy game-unlock-commander --no-verify-jwt`
