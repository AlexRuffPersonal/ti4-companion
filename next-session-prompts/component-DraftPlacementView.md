# Task: component-DraftPlacementView
...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-DraftPlacementView.md`
...
`ti4-companion-web/src/components/game/DraftPlacementView.jsx`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-DraftPlacementView` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-DraftPlacementView.md`
