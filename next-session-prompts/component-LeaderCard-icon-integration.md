# Task: component-LeaderCard-icon-integration
...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-LeaderCard-icon-integration.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-LeaderCard-icon-integration` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-LeaderCard-icon-integration.md`
