# Task: client-edgeFunctions-mech
...
`ti4-companion-web/docs/superpowers/plans/main_plan/client-edgeFunctions-mech.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `client-edgeFunctions-mech` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/client-edgeFunctions-mech.md`
