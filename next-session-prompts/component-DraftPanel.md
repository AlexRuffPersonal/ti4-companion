...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-DraftPanel.md`
...
`ti4-companion-web/src/components/game/DraftPanel.jsx`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-DraftPanel` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-DraftPanel.md`
