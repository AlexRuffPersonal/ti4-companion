...
`ti4-companion-web/docs/superpowers/plans/main_plan/hook-useDraft.md`
...
`ti4-companion-web/src/hooks/useDraft.js`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `hook-useDraft` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/hook-useDraft.md`
