...
| [fn-game-produce-units-p39b](fn-game-produce-units-p39b.md) | `supabase/functions/game-produce-units/index.ts` | 39b | Promissory Note DSL Effects | in-progress | fn-game-play-promissory-note-p39a, shared-promissoryEnforcement-p39a |
...
| [fn-game-roll-ground-combat-dice-p39b](fn-game-roll-ground-combat-dice-p39b.md) | `supabase/functions/game-roll-ground-combat-dice/index.ts` | 39b | Promissory Note DSL Effects | in-progress | fn-game-play-promissory-note-p39a |
...
| [fn-game-research-technology-p39b](fn-game-research-technology-p39b.md) | `supabase/functions/game-research-technology/index.ts` | 39b | Promissory Note DSL Effects | in-progress | fn-game-play-promissory-note-p39a, shared-promissoryEnforcement-p39a |
...
| [fn-game-resolve-exploration-card-p39](fn-game-resolve-exploration-card-p39.md) | `supabase/functions/game-resolve-exploration-card/index.ts` | 41 | Exploration Full Validation | in-progress | fn-game-resolve-exploration-card, migration-051-exploration-fixes, shared-explorationEffects-p39, shared-abilityDsl-p39 |
...
| [fn-game-land-troops-p39](fn-game-land-troops-p39.md) | `supabase/functions/game-land-troops/index.ts` | 41 | Exploration Full Validation | in-progress | fn-game-land-troops-p26, migration-051-exploration-fixes |
