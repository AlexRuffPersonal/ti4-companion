# Task: fn-game-roll-combat-dice-p43c
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-roll-combat-dice-p43c.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-roll-combat-dice-p43c` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-roll-combat-dice-p43c.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy game-roll-combat-dice --no-verify-jwt`
