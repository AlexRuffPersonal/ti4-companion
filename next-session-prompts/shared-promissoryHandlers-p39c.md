# Task: shared-promissoryHandlers-p39c
...
`ti4-companion-web/docs/superpowers/plans/main_plan/shared-promissoryHandlers-p39c.md`
...
`supabase/functions/_shared/promissoryHandlers.ts`

## Phase / Feature Area
Phase 39c — Promissory Note DSL Effects
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `shared-promissoryHandlers-p39c` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/shared-promissoryHandlers-p39c.md`
