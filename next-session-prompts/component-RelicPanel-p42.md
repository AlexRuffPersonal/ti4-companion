...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-RelicPanel-p42.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-RelicPanel-p42` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-RelicPanel-p42.md`
