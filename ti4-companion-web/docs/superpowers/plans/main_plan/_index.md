...
| [fn-game-resolve-exploration-card-p42](fn-game-resolve-exploration-card-p42.md) | `supabase/functions/game-resolve-exploration-card/index.ts` | 42 | Relic Card Effects A | in-progress | fn-game-resolve-exploration-card, shared-relicEffects-p42, shared-abilityDsl-p42 |
