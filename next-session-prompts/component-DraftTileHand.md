...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-DraftTileHand.md`
...
`ti4-companion-web/src/components/game/DraftTileHand.jsx`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-DraftTileHand` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-DraftTileHand.md`
