# Task: shared-leaderEffects-p43c
...
`ti4-companion-web/docs/superpowers/plans/main_plan/shared-leaderEffects-p43c.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `shared-leaderEffects-p43c` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/shared-leaderEffects-p43c.md`
