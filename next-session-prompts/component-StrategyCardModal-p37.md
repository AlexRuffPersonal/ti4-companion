# Task: component-StrategyCardModal-p37
...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-StrategyCardModal-p37.md`
...
`ti4-companion-web/src/components/game/StrategyCardModal.jsx`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-StrategyCardModal-p37` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-StrategyCardModal-p37.md`
