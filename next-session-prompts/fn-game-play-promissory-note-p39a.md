# Task: fn-game-play-promissory-note-p39a
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-play-promissory-note-p39a.md`
...
`supabase/functions/game-play-promissory-note/index.ts`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-play-promissory-note-p39a` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-play-promissory-note-p39a.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy game-play-promissory-note --no-verify-jwt`
