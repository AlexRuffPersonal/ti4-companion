...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-start-draft.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-start-draft` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-start-draft.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy game-start-draft --no-verify-jwt`
