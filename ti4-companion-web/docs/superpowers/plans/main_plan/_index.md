...
| [fn-game-roll-ground-combat-dice-p43c](fn-game-roll-ground-combat-dice-p43c.md) | `supabase/functions/game-roll-ground-combat-dice/index.ts` | 43c | Leader Card Abilities — Commander Passives | in-progress | shared-leaderEffects-p43c, shared-abilityHandlers-p43c, fn-game-roll-combat-dice-p43c |
