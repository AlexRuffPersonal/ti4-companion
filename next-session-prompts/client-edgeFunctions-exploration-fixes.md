# Task: client-edgeFunctions-exploration-fixes
...
`ti4-companion-web/docs/superpowers/plans/main_plan/client-edgeFunctions-exploration-fixes.md`
...
`ti4-companion-web/src/lib/edgeFunctions.js`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `client-edgeFunctions-exploration-fixes` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/client-edgeFunctions-exploration-fixes.md`
