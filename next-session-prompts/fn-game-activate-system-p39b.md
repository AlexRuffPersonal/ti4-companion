# Task: fn-game-activate-system-p39b
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-activate-system-p39b.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-activate-system-p39b` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-activate-system-p39b.md`
