# Task: shared-promissoryEnforcement-p39a
...
`ti4-companion-web/docs/superpowers/plans/main_plan/shared-promissoryEnforcement-p39a.md`
...
`supabase/functions/_shared/promissoryEnforcement.ts`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `shared-promissoryEnforcement-p39a` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/shared-promissoryEnforcement-p39a.md`
