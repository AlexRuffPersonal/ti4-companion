# Task: component-LeaderAbilityModal
...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-LeaderAbilityModal.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-LeaderAbilityModal` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-LeaderAbilityModal.md`
