# Task: migration-051-exploration-fixes
...
`ti4-companion-web/docs/superpowers/plans/main_plan/migration-051-exploration-fixes.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `migration-051-exploration-fixes` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/migration-051-exploration-fixes.md`
