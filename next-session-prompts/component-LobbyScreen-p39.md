# Task: component-LobbyScreen-p39
...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-LobbyScreen-p39.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-LobbyScreen-p39` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-LobbyScreen-p39.md`
