...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-assign-hits-p43a.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-assign-hits-p43a` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-assign-hits-p43a.md`
