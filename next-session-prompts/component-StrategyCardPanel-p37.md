# Task: component-StrategyCardPanel-p37
...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-StrategyCardPanel-p37.md`
...
`ti4-companion-web/src/components/game/StrategyCardPanel.jsx`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-StrategyCardPanel-p37` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-StrategyCardPanel-p37.md`
