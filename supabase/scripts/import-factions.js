// Run from the project root: node supabase/scripts/import-factions.js
//
...
const JSON_FILE = path.resolve(__dirname, '../jsons/factions.json')
const FUNCTION_URL = 'https://mgbagajfrfielqrjpuvi.supabase.co/functions/v1/admin-import-factions'
