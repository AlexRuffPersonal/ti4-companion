...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-use-relic-p42.md`
...
`supabase/functions/game-use-relic/index.ts`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-use-relic-p42` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-use-relic-p42.md`
...
- After implementing this Edge Function, deploy it: `supabase functions deploy game-use-relic --no-verify-jwt`
