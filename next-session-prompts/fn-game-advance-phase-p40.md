# Task: fn-game-advance-phase-p40
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-advance-phase-p40.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-advance-phase-p40` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-advance-phase-p40.md`
