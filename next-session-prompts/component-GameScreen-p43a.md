# Task: component-GameScreen-p43a
...
`ti4-companion-web/docs/superpowers/plans/main_plan/component-GameScreen-p43a.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `component-GameScreen-p43a` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/component-GameScreen-p43a.md`
