// Run from the project root: node supabase/scripts/import-tiles.js
//
...
const JSON_FILE = path.resolve(__dirname, '../jsons/tiles.json')
const FUNCTION_URL = 'https://mgbagajfrfielqrjpuvi.supabase.co/functions/v1/admin-import-tiles'
...
async function main() {
  ...
  console.log(`Importing ${records.length} tiles...`)
