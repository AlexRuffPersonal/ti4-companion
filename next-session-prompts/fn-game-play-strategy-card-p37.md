# Task: fn-game-play-strategy-card-p37
...
`ti4-companion-web/docs/superpowers/plans/main_plan/fn-game-play-strategy-card-p37.md`
...
5. Update `ti4-companion-web/docs/superpowers/plans/main_plan/_index.md`: change Status of `fn-game-play-strategy-card-p37` from `planned` to `done`
6. Delete this prompt file: `next-session-prompts/fn-game-play-strategy-card-p37.md`
